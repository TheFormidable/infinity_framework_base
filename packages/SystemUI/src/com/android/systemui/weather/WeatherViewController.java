...
public class WeatherViewController implements OmniJawsClient.OmniJawsObserver {
    ...
    private Runnable mDebouncedUpdate = this::updateWeatherSettings;

    private long lastWeatherQueryTime = 0;
    private static final long MIN_QUERY_INTERVAL_MS = 5 * 60 * 1000;
    ...
    static {
        ...
        WEATHER_CONDITIONS.put("clear", R.string.weather_condition_clear_evening);
    ...
    private void queryAndUpdateWeather() {
        ...
        if (currentTime - lastWeatherQueryTime < MIN_QUERY_INTERVAL_MS || isQueryInProgress) {
            return;
        }
        lastWeatherQueryTime = currentTime;
    ...
    class SettingsObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            mHandler.removeCallbacks(mDebouncedUpdate);
            mHandler.postDelayed(mDebouncedUpdate, DEBOUNCE_DELAY_MS);
        }
    }
}
