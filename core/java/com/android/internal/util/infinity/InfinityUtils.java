...
public class InfinityUtils {
    ...
    // Disable packages
    public static void disablePackages(String[] packages, Context context) {
        PackageManager pm = context.getPackageManager();
	for (String packageName : packages) {
	    if (!isPackageInstalled(context, packageName, true)) {
		Log.d("ClockStyle", "Package not installed: " + packageName);
		continue;
	    }
	    try {
		...
		Log.d("ClockStyle", "Disabled package: " + packageName);
            } catch (Exception e) {
		Log.e("ClockStyle", "Failed to disable package: " + packageName, e);
            }
	}
    }

    // Enable packages
    public static void enablePackages(String[] packages, Context context) {
	PackageManager pm = context.getPackageManager();
	for (String packageName : packages) {
	    if (!isPackageInstalled(context, packageName, true)) {
		Log.d("ClockStyle", "Package not installed: " + packageName);
		...
		Log.d("ClockStyle", "Enabled package: " + packageName);
            } catch (Exception e) {
		Log.e("ClockStyle", "Failed to enable package: " + packageName, e);
	    }
	}
    }
